...
import { useGetMeetingsByCourseAndStatusQuery, useGetPendingMeetingsQuery } from "../api/apiSlice";
...
function MeetingTableOld(props) {
    ...
    const { data: meetings = [], isSuccess, refetch } = useGetPendingMeetingsQuery({ course: course?.id });
...
export default MeetingTableOld;